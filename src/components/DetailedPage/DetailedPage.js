      ...
      <div className='DetailedPageContainer'>
        <div className='DetailedPageWrapper'>
          <span>
            ...
            I enjoy being a web developer because it allows me to train my brain and logic while creating powerful digital tools that can help others.
          ...
          <div className='DetailsGrid'>
            ...
            <span>I did an internship for 4 months at the company <a href='https://www.helppier.com/en/' target="_blank" rel="noreferrer">Helppier</a> as a unit of my degree. This was the first time working professionally, developing a web app with a team of professional developers.
            ...
            <span>At <a href='https://www.glookast.com/' target="_blank" rel="noreferrer">Glookast</a> I had my first professional experience after taking my degree. For 1 year and 10 months I helped develop several softwares made by the company.
